public class CurrentControlVoltageSource extends Element {
    ...
    public CurrentControlVoltageSource(float current, float voltage, float power, String node1, String node2, String name, String controlNode1, String controlNode2, float gain) {
