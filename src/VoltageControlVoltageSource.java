...
public class VoltageControlVoltageSource extends Element {
    ...
    public VoltageControlVoltageSource(ComplexNumber current, ComplexNumber voltage, ComplexNumber power, int node1, int node2, ComplexNumber node1Voltage, ComplexNumber node2Voltage, String name, int controlNode1, int controlNode2, float gain) {
